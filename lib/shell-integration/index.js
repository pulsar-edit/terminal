...
async function injectZsh(originalArgs, envMixin, env) {
    ...
    await Promise.all([
        fs__default.default.copy(path__namespace.join(SCRIPT_ROOT, 'shell-integration-rc.zsh'), path__namespace.join(zdotdir, '.zshrc')),
        fs__default.default.copy(path__namespace.join(SCRIPT_ROOT, 'shell-integration-profile.zsh'), path__namespace.join(zdotdir, '.zprofile')),
        fs__default.default.copy(path__namespace.join(SCRIPT_ROOT, 'shell-integration-env.zsh'), path__namespace.join(zdotdir, '.zshenv')),
        fs__default.default.copy(path__namespace.join(SCRIPT_ROOT, 'shell-integration-login.zsh'), path__namespace.join(zdotdir, '.zlogin'))
    ]);
