...
function getTheme() {
    let theme = atom.config.get(`${utils.PACKAGE_NAME}.appearance.theme`);
    let customThemeColors = atom.config.get(`${utils.PACKAGE_NAME}.appearance.customThemeColors`) ?? {};
...
function getSearchTheme() {
    let theme = atom.config.get(`${utils.PACKAGE_NAME}.appearance.theme`);
    let { matchBorder, activeMatchBorder, matchBackground, activeMatchBackground, foreground, background } = atom.config.get(`${utils.PACKAGE_NAME}.appearance.customThemeColors`) ?? {};
...
exports.getSearchTheme = getSearchTheme;
