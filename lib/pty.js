...
class Pty {
    ...
    async start() {
        ...
        tslib.__classPrivateFieldGet(this, _Pty_instances, "m", _Pty_sendMessage).call(this, spawnMessage);
    ...
    kill(signal) {
        if (utils.isWindows()) {
            tslib.__classPrivateFieldGet(this, _Pty_instances, "m", _Pty_killOnWindows).call(this);
        }
        else {
            tslib.__classPrivateFieldGet(this, _Pty_instances, "m", _Pty_killProcess).call(this, signal);
        }
        this.destroy();
    }
    forceKill() {
    ...
    write(data) {
        ...
        tslib.__classPrivateFieldGet(this, _Pty_instances, "m", _Pty_sendMessage).call(this, message);
    }
    destroy() {
        this.destroyed = true;
    ...
    async booted() {
        return await tslib.__classPrivateFieldGet(this, _Pty_instances, "m", _Pty_waitForReadyState).call(this, PtyState.BOOTED);
    }
    async ready() {
        return await tslib.__classPrivateFieldGet(this, _Pty_instances, "m", _Pty_waitForReadyState).call(this, PtyState.READY);
    }
    pause() {
        tslib.__classPrivateFieldGet(this, _Pty_instances, "m", _Pty_sendMessage).call(this, {
            type: 'pause',
            payload: null
        });
    }
...
_Pty_instances = new WeakSet(), _Pty_sendMessage = function _Pty_sendMessage(message) {
    ...
    try {
        ...
        tslib.__classPrivateFieldGet(this, _Pty_instances, "m", _Pty_killProcess).call(this);
        return;
    }
