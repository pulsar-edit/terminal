...
const ALLOWED_LOCATIONS = ['left', 'right', 'center', 'bottom'];
/**
...
class TerminalModel {
    ...
    handleNewData() {
        ...
        if (this.title !== tslib_es6.__classPrivateFieldGet(this, _TerminalModel_lastTitle, "f")) {
            this.emitter.emit('did-change-title', this.getTitle());
        }
        tslib_es6.__classPrivateFieldSet(this, _TerminalModel_lastTitle, this.title, "f");
    }
    isActive() {
    ...
    applyProfileChanges(_profileChanges) {
        // TODO
    }
    getSessionId() {
