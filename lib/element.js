...
class TerminalElement extends HTMLElement {
    ...
    optionallyWarnAboutModifierlessClick() {
        ...
        atom.notifications.addInfo(`Terminal: Click ignored`, {
            description: `For security and protection against accidental clicks, you must hold <kbd>${utils.isMac() ? 'Cmd' : 'Ctrl'}</kbd> while clicking URLs. You may disable this requirement in the package settings. (This message will be shown only once.)`,
            dismissable: true,
            buttons: [
                {
