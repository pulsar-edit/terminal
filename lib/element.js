...
var _TerminalElement_instances, _TerminalElement_mainResizeObserver, _TerminalElement_mainContentRect, _TerminalElement_terminalIntersectionObserver, _TerminalElement_terminalInitiallyVisible, _TerminalElement_fitAddon, _TerminalElement_searchAddon, _TerminalElement_webglAddon, _TerminalElement_prioritizedPrefixes, _TerminalElement_ptyMeta, _TerminalElement_loseWebglContext, _TerminalElement_bindingMatchesAncestorChain, _TerminalElement_shouldPrioritizeBinding, _TerminalElement_keymapHasPendingPartialMatches, _TerminalElement_keyboardEventMatchesKeybinding, _TerminalElement_buildAncestorChain, _TerminalElement_clipboardBindingForKeyboardEvent, _TerminalElement_createTerminal;
/**
...
_TerminalElement_mainResizeObserver = new WeakMap(), _TerminalElement_mainContentRect = new WeakMap(), _TerminalElement_terminalIntersectionObserver = new WeakMap(), _TerminalElement_terminalInitiallyVisible = new WeakMap(), _TerminalElement_fitAddon = new WeakMap(), _TerminalElement_searchAddon = new WeakMap(), _TerminalElement_webglAddon = new WeakMap(), _TerminalElement_prioritizedPrefixes = new WeakMap(), _TerminalElement_ptyMeta = new WeakMap(), _TerminalElement_instances = new WeakSet(), _TerminalElement_loseWebglContext = function _TerminalElement_loseWebglContext() {
    ...
    if (config.Config.get('xterm.webgl')) {
        ...
        if (tslib.__classPrivateFieldGet(this, _TerminalElement_webglAddon, "f")) {
            this.terminal.loadAddon(tslib.__classPrivateFieldGet(this, _TerminalElement_webglAddon, "f"));
        }
    }
