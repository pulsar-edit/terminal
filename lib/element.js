...
var addonLigatures = require('./node_modules/@xterm/addon-ligatures/lib/addon-ligatures.js');
...
var _TerminalElement_instances, _TerminalElement_mainResizeObserver, _TerminalElement_mainContentRect, _TerminalElement_terminalIntersectionObserver, _TerminalElement_terminalInitiallyVisible, _TerminalElement_fitAddon, _TerminalElement_searchAddon, _TerminalElement_ptyMeta, _TerminalElement_createTerminal;
...
function shouldPrioritizeBinding(kb, ancestorChain) {
...
function keyboardEventMatchesKeybinding(event) {
    ...
    let result = bindings.exactMatchCandidates.some((kb) => shouldPrioritizeBinding(kb, ancestorChain));
    if (result) {
