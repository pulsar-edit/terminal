...
var _DelayedPresence_instances, _DelayedPresence_inState, _DelayedPresence_isSame, _DelayedPresence_reset, _DelayedPresence_effectiveShowDelay, _DelayedPresence_cancelTimer, _TerminalElement_instances, _TerminalElement_mainResizeObserver, _TerminalElement_mainContentRect, _TerminalElement_terminalIntersectionObserver, _TerminalElement_terminalInitiallyVisible, _TerminalElement_fitAddon, _TerminalElement_searchAddon, _TerminalElement_shellIntegrationAddon, _TerminalElement_prioritizedPrefixes, _TerminalElement_ptyMeta, _TerminalElement_shouldPrioritizeBinding, _TerminalElement_keymapHasPendingPartialMatches, _TerminalElement_keyboardEventMatchesKeybinding, _TerminalElement_createTerminal, _TerminalElement_restartPtyProcess;
/**
...
_TerminalElement_mainResizeObserver = new WeakMap(), _TerminalElement_mainContentRect = new WeakMap(), _TerminalElement_terminalIntersectionObserver = new WeakMap(), _TerminalElement_terminalInitiallyVisible = new WeakMap(), _TerminalElement_fitAddon = new WeakMap(), _TerminalElement_searchAddon = new WeakMap(), _TerminalElement_shellIntegrationAddon = new WeakMap(), _TerminalElement_prioritizedPrefixes = new WeakMap(), _TerminalElement_ptyMeta = new WeakMap(), _TerminalElement_instances = new WeakSet(), _TerminalElement_shouldPrioritizeBinding = function _TerminalElement_shouldPrioritizeBinding(kb, ancestorChain) {
