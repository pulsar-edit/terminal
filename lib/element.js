...
_TerminalElement_mainResizeObserver = new WeakMap(), _TerminalElement_mainContentRect = new WeakMap(), _TerminalElement_terminalIntersectionObserver = new WeakMap(), _TerminalElement_terminalInitiallyVisible = new WeakMap(), _TerminalElement_fitAddon = new WeakMap(), _TerminalElement_searchAddon = new WeakMap(), _TerminalElement_prioritizedPrefixes = new WeakMap(), _TerminalElement_ptyMeta = new WeakMap(), _TerminalElement_instances = new WeakSet(), _TerminalElement_bindingMatchesAncestorChain = function _TerminalElement_bindingMatchesAncestorChain(kb, ancestorChain) {
